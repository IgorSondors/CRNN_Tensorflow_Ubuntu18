...
sys.path.append('/home/sondors/CRNN_Tensorflow_Ubuntu18/config')
sys.path.append('/home/sondors/CRNN_Tensorflow_Ubuntu18/local_utils')
sys.path.append('/home/sondors/CRNN_Tensorflow_Ubuntu18/data_provider')

#from data_provider import tf_io_pipline_fast_tools
import global_config
import establish_char_dict
import tf_io_pipline_fast_tools

#__name__ = 'tf_io_pipline_fast_tools'
...
class CrnnDataProducer(object):
    ...
    def __init__(self, dataset_dir, char_dict_path=None, ord_map_dict_path=None,
        ...
        self._train_annotation_file_path = ops.join('/home/sondors/CRNN_Tensorflow_Ubuntu18/data/annotations_Over400pix_static', 'annotation_train.txt')
        self._test_annotation_file_path = ops.join('/home/sondors/CRNN_Tensorflow_Ubuntu18/data/annotations_Over400pix_static', 'annotation_test.txt')
        self._val_annotation_file_path = ops.join('/home/sondors/CRNN_Tensorflow_Ubuntu18/data/annotations_Over400pix_static', 'annotation_val.txt')
        self._lexicon_file_path = ops.join('/home/sondors/CRNN_Tensorflow_Ubuntu18/data/annotations_Over400pix_static', 'lexicon.txt')
        ##############################################################################################################################################
    ...
    def _init_dataset_sample_info(self):
        ...
        num_lines = sum(1 for _ in open(self._lexicon_file_path, 'r', encoding="utf8"))
        ...
        num_lines = sum(1 for _ in open(self._train_annotation_file_path, 'r', encoding="utf8"))
        ...
        num_lines = sum(1 for _ in open(self._val_annotation_file_path, 'r', encoding="utf8"))
        ...
        num_lines = sum(1 for _ in open(self._test_annotation_file_path, 'r', encoding="utf8"))
...
class CrnnDataFeeder(object):
    ...
    def __init__(self, dataset_dir, char_dict_path, ord_map_dict_path, flags='train'):
        ...
        self._tfrecords_dir = ops.join(dataset_dir, 'records_save')
