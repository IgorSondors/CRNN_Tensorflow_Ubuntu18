...
#__C.ARCH.INPUT_SIZE = (460, 32)# Over400pix
# Number of channels in images
__C.ARCH.INPUT_CHANNELS = 3
# Number character classes
__C.ARCH.NUM_CLASSES = 81 # ru dataset
...
__C.TRAIN.EPOCHS = 54000#370000#200000#0
...
__C.TRAIN.LEARNING_RATE = 0.0000125#0.001#0.0005#0.01
# Set the GPU resource used during training process
__C.TRAIN.GPU_MEMORY_FRACTION = 0.9
# Set the GPU allow growth parameter during tensorflow training process
__C.TRAIN.TF_ALLOW_GROWTH = True
# Set the shadownet training batch size
__C.TRAIN.BATCH_SIZE = 18#16#32
# Set the shadownet validation batch size
__C.TRAIN.VAL_BATCH_SIZE = 18#16#32
# Set the learning rate decay steps
__C.TRAIN.LR_DECAY_STEPS = 100000#50000000#50000
# Set the learning rate decay rate
__C.TRAIN.LR_DECAY_RATE = 0.5#0.1
