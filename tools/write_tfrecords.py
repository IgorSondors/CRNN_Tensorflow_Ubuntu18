...
def init_args():
    ...
    parser.add_argument('-d', '--dataset_dir', type=str, help='The origin synth90k dataset_dir', default = '/home/sondors/dataset')
    parser.add_argument('-s', '--save_dir', type=str, help='The generated tfrecords save dir', default = '/home/sondors/Recognizer/CRNN_Tensorflow_Ubuntu18/records_save')
