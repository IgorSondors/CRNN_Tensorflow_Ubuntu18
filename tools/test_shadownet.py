...
def init_args():
    ...
    parser.add_argument('--image_path', type=str,
                        ...
                        default='/home/sondors/Recognizer/CRNN_Tensorflow_Ubuntu18/ubunt_for/crop/2.jpg')
    parser.add_argument('--weights_path', type=str,
                        help='Path to the pre-trained weights to use', default = '/home/sondors/Recognizer/CRNN_Tensorflow_Ubuntu18/model/crnn_syn90k_after22.04/shadownet_2020-04-24-01-00-37.ckpt-12000')
    parser.add_argument('-c', '--char_dict_path', type=str,
                        help='Directory where character dictionaries for the dataset were stored', default = '/home/sondors/Recognizer/CRNN_Tensorflow_Ubuntu18/data/char_dict_after22.04/char_dict.json')
    parser.add_argument('-o', '--ord_map_dict_path', type=str,
                        help='Directory where ord map dictionaries for the dataset were stored', default = '/home/sondors/Recognizer/CRNN_Tensorflow_Ubuntu18/data/char_dict_after22.04/ord_map.json')
