...
def init_args():
    ...
    parser.add_argument('-d', '--dataset_dir', type=str,
                        help='Directory containing train_features.tfrecords', default = '/home/sondors/Recognizer/CRNN_Tensorflow_Ubuntu18')
    parser.add_argument('-w', '--weights_path', type=str,
                        help='Path to pre-trained weights to continue training')#, default = '/home/sondors/Recognizer/CRNN_Tensorflow_Ubuntu18/model/crnn_syn90k/shadownet_2020-05-22-02-14-55.ckpt-34000')
    parser.add_argument('-c', '--char_dict_path', type=str,
                        help='Directory where character dictionaries for the dataset were stored', default = '/home/sondors/Recognizer/CRNN_Tensorflow_Ubuntu18/data/char_dict/char_dict.json')
    parser.add_argument('-o', '--ord_map_dict_path', type=str,
                        help='Directory where ord map dictionaries for the dataset were stored', default = '/home/sondors/Recognizer/CRNN_Tensorflow_Ubuntu18/data/char_dict/ord_map.json')
    parser.add_argument('-e', '--decode_outputs', type=args_str2bool,
