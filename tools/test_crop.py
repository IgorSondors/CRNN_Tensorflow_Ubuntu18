...
def recognize(image_path, weights_path, char_dict_path, ord_map_dict_path):
    ...
    for i in range(10529):#(quantity_of_files):
        print(i, 'image processing')

        #load and normalize an image
        one_of_images =  '/home/sondors/Recognizer/CRNN_Tensorflow_Ubuntu18/ubunt_for/crops_ubuntu/{}.jpg'.format(i)
    ...
    with sess.as_default():
        ...
        for i in range(10529):#(quantity_of_files):
            ...
            #print(i, 'image recognition result is', preds)
            #print('size of preds', i+500, 'is',sys.getsizeof(preds))
            test_img.write(preds+ '\n')
...
weights_path = '/home/sondors/Recognizer/CRNN_Tensorflow_Ubuntu18/model/crnn_syn90k/shadownet_2020-05-20-01-15-40.ckpt-92000'#'/home/sondors/Recognizer/CRNN_Tensorflow_Ubuntu18/model/crnn_syn90k (another copy)/shadownet_2020-04-30-23-25-20.ckpt-44000'
...
with open("/home/sondors/Recognizer/CRNN_Tensorflow_Ubuntu18/ubunt_for/from1000/crops_rocogn.txt",'w', encoding="utf8") as test_img:
